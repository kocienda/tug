...
overwrites a file that already exists. Filling it in is a person's job — there
is no derivation from the commit log, because the notes are addressed to
someone who does not read this repository.
