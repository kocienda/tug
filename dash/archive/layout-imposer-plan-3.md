...
Flow mode shipped in `dash/layout-imposer-polish.md` (milestone M04, landed as `093bd879a`). It works, and three things about it read badly on a live deck.
...
- The gauge channel ([P08] of `dash/layout-imposer-polish.md`), `tugdeck/src/lib/imposer-gauges.ts` — present.
