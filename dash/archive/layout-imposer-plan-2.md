...
- `dash/layout-imposer-brief-2.md` — the investigation this plan executes.
...
**Implications:**
- The header comment is rewritten, not deleted; it cites `dash/layout-imposer-brief-2.md` for the reversal.
...
| #step-17 | H — autoscroll and doctrine | done | `ca466153d` |
| #step-18 | H — integration checkpoint | done | `ca466153d` |
...
- [ ] Rewrite the header's decision paragraph: previews at rest (unchanged rationale), committed live (cite `dash/layout-imposer-brief-2.md`).
