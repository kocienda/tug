...
- [ ] Update `dash/closing-dash-backend-issues-brief.md`: mark the three findings closed with one line each naming the mechanism, and state that the campaign is closed — items 5 and 7 remain, as tripwire and pull-driven work respectively.
