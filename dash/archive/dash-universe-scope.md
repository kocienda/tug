...
- [ ] Round 2 of `dash/close-dash-join-gaps.md` — the verified landing (merged-tree build + `@covers`-derived selection as a server-owned feed fact), which consumes this round's worktree-capable harness.
