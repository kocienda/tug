...
`dash/join-voice.md` landed (`e289fe517`) and `dash/dash-generality.md` landed (`a18557090`); both verified present on `main` at authoring time, along with `2ddcace0a` from 2026-08-16.
