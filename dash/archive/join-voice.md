...
- `dash/join-arc-2.md` landed (`0519182d2`) — the feedback spine (`expectServerJoin`), worktree-aware binding, and [D149] are assumed present.
...
**Checkpoint:**
- [ ] The rg probe above, and `tugutil plan lint dash/join-voice.md` still exits 0.
...
- [ ] The generality seam for per-project verify/build declarations (`dash/dash-generality.md`, queued next).
