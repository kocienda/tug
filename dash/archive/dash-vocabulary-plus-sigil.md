...
- **Retiring old roadmap documents.** `dash/archive/**` and superseded briefs are history and are left alone.
...
- [ ] Leave `dash/archive/**` and superseded briefs alone — they are history ([#non-goals](#non-goals)).
