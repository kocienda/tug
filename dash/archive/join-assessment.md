...
Next piece of work: the **tactical layer** — item 4 of the suggested order, and the only one still open. The first three are addressed; the base-motion program was designed, implemented, and written down in [`dash/base-motion-replay-plan.md`](base-motion-replay-plan.md).
