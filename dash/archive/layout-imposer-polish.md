...
The drop-zone drag engine ([P09] of `dash/layout-imposer-plan-2.md`) shipped working but not polished. Four defects stand, reported from hand-testing on the live deck:
