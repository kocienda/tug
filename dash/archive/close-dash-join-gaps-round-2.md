...
This is Round 2 of `dash/close-dash-join-gaps.md`. Round 1 (`dash/dash-universe-scope.md`, joined 2026-08-19) gave the app-test harness an explicit repo universe (`TUG_REPO_UNIVERSE`) so tests run from any worktree — which is the capability this round's verification tier consumes.
...
- [ ] `dash/close-dash-join-gaps.md`: correct its terminology note to the refined ruling (umbrella "land" survives); mark Round 2 in progress.
