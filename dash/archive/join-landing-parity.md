...
- `dash/unified-changes.md` landed (the shade-as-decision-surface join arc, [D152]) — the join flow this plan's receipt work observes.
...
- [ ] Entry points into dash workflows (`dash/dash-entry-points.md`, next in the queue).
- [ ] The dash/join closure sweep (`dash/dash-join-tail.md`).
