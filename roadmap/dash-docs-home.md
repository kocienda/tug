...
|---|---|---|---|
| #step-1 | The `docs` declaration and its verb | pending | — |
| #step-2 | Plan search derives from the declaration | pending | — |
| #step-3 | The skills speak the resolver | pending | — |
| #step-4 | This repository migrates | pending | — |
| #step-5 | Human surfaces stop naming the tool | pending | — |
