...
describe.skipIf(!SHOULD_RUN)("AT0473: the arc cockpit lists waiting plans", () => {
  test(
    ...
    async () => {
      ...
      try {
        ...
        const adopter = createArc(dirA(), ADOPTER, "at0473 adopter", projectA!.cli);
        ...
        const arc = createArc(dirA(), ARC_NAME, "at0473 fixture", projectA!.cli);
        ...
        expect(arcBox.dots).toEqual(["stopped", "stopped"]);
        ...
        expect(arcBox.aria).toBe(`arc ${ARC_NAME}, step 1 of 3`);
