 ...
 * [`arc/dev-atoms.md`](../../../arc/dev-atoms.md#t03-downsample-decisions)
 ...
 *
 * References:
 *  - [Spec S04] image-downsample contract — `arc/dev-atoms.md#s04-image-downsample`
 *  - [D05] client-side downsample at insert — `arc/dev-atoms.md#d05-client-downsample`
 *  - [Table T03] downsample decision matrix — `arc/dev-atoms.md#t03-downsample-decisions`
 *  - [Q02] HEIC / AVIF empirical findings — `arc/dev-atoms.md#q02-heic-avif`
 *  - [Q04] animated GIF policy — `arc/dev-atoms.md#q04-animated-gif`
 *  - [Risk R01] canvas blocking — `arc/dev-atoms.md#r01-canvas-blocking`
...
// drop. See Step 3.5.3 in `arc/dev-atoms.md`.
//
 ...
 *
 * Called by `synthesizeUserMessageFromBlocks` ([Step 5c](arc/dev-atoms.md#step-5c))
 ...
 * the per-message attachment strip ([Step 6](arc/dev-atoms.md#step-6))
