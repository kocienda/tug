...
use crate::dash::{DashDeclarations, StepPhase, read_declarations, step_declaration_note};
use crate::ops;
...
/// [`crate::dash::append_dash_log`], the same door every other declaration
...
pub fn doctor(repo_root: &Path, name: &str, repair: bool) -> Result<DoctorOutcome, String> {
    ...
    if repair {
        for finding in &diagnosis.findings {
            ...
            crate::dash::append_dash_log(repo_root, name, &fix.marker, &fix.note)
