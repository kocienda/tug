...
- **`reading`** — an atom in a block at reading scale, where there is no line to disturb and the mark can breathe. The Changes shade's arc block, the telemetry placard.
