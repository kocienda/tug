...
<!--
  ...
  `tuglaws/devise-skeleton.md`, the format for plans.
  ...
  from it. If you find yourself writing steps, you are writing a plan, and the
  ...
  *positively*, by the presence of an `{#execution-steps}` section, so pointing it at
  ...
  So: every section below may be omitted when it has nothing to say. Where the devise
  skeleton is mandatory, this one is permissive. Say the true thing briefly; do not
