...
| `tugdeck/src/lib/drop-zones.ts` | Pure drop-zone vocabulary and geometry: `DropZone`, `enumerateDropZones`, `pickLiveZone`, `autoscrollDelta`, and the feel constants ([Q01]) |
