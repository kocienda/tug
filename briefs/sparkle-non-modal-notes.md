Mitchell Hashimoto (the author of Ghostty) decided that the standard Sparkle update dialog was too disruptive and replaced it with a custom, non-modal update UI built on Sparkle’s custom user-driver APIs.  
